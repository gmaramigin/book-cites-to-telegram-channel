...
scheduler.add_job(lambda: asyncio.run(fetch_quotes()), 'cron', hour=5, minute=50)
scheduler.add_job(lambda: asyncio.run(send_quote_to_channel()), 'cron', hour=6, minute=0)
scheduler.start()
